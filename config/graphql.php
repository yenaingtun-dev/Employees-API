...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // ExampleQuery::class,
                App\GraphQL\Queries\EmployeeQuery::class,
                App\GraphQL\Queries\EmployeesQuery::class
            ],
            'mutation' => [
                // ExampleMutation::class,
                App\GraphQL\Mutations\CreateEmployeeMutation::class,
                App\GraphQL\Mutations\UpdateEmployeeMutation::class,
                App\GraphQL\Mutations\DeleteEmployeeMutation::class,
            ],
            // The types only available in this schema
            'types' => [
                // ExampleType::class,
                \App\GraphQL\Types\EmployeeType::class
            ],
